...
function AvgWinLossCombinedBar({ avgWin, avgLoss, capital, totalDeposit, isDark, t }: { avgWin: number; avgLoss: number; capital: number; totalDeposit?: number; isDark: boolean; t: any }) {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-full pb-1">
      <div className="flex w-full gap-3">
        ...
        <div className="flex-1 flex flex-col items-center justify-center py-2.5 rounded-xl border" style={{ background: isDark ? 'rgba(244, 63, 94, 0.05)' : 'rgba(244, 63, 94, 0.1)', borderColor: isDark ? 'rgba(244, 63, 94, 0.1)' : 'rgba(244, 63, 94, 0.2)' }}>
