        ...
        <div className="py-8 px-4 shadow-xl sm:rounded-2xl sm:px-10 border" style={{ backgroundColor: '#14141C', borderColor: '#22222E' }}>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                type="button"
                className="w-full flex justify-center items-center py-2.5 px-4 border rounded-xl shadow-sm text-sm font-medium transition hover:brightness-125 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#14141C] focus:ring-[#84CC16]"
                style={{ backgroundColor: '#09090D', borderColor: '#22222E', color: '#E5E7EB' }}
              >
